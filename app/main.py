...
def check_app_version():
    ...
    """
    return {
        "version": "0.0.4",  # 🔥 배포할 최신 버전 (version.txt보다 높아야 업데이트됨)
        
        # 👇 [중요] 아까 GitHub Releases에서 복사한 '링크 주소'를 여기에 넣으세요!
        "download_url": "https://github.com/ProjectResolutionsOffice/new_create_page_main/releases/download/v0.0.4/update_v0.0.4.zip",
